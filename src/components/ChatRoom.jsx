...
export default function ChatRoom() {
  ...
  return (
    <div className="bg-zinc-900 border border-gray-700 p-6 rounded-xl shadow-lg max-w-xl mx-auto mt-5">
      ...
      {/* Area pesan */}
      <div className="h-72 overflow-y-auto border border-gray-700 p-3 rounded-lg bg-zinc-800 mb-4 space-y-3 flex items-center justify-center text-gray-400">
        <p>Chat kosong - Login untuk memulai percakapan</p>
      </div>
